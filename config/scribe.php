...
return [
     ...
     */
    'description' => "Quote Generator API Documentation",
    ...
    'intro_text' => <<<INTRO
    <aside>
    The online quote is a platform that allows users to benefit from advantages such as the realization of quotes with the cost of the dollar defined in real time without the need for qualified people and from any device, as well as a daily update on the price list of the licenses sold by Microsoft.
    </aside>
    INTRO,
